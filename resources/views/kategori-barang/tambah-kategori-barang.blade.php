    ...
    <main class="main-container">
        <div class="main-title">
            <div class="home-content">
                <h3>ADD PRODUCT CATEGORY DATA</h3>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            <div class="x_content">
                                <br />
                                <form id="demo-form2" action="{{ route('kategori_barang.store') }}" data-parsley-validate
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input id="middle-name" name="kategori_barang" class="form-control"
