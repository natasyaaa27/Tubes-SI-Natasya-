                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            <div class="x_content">
                                <br />
                                <form id="demo-form2" action="{{ route('pembeli.update', $pembeli->id_pembeli) }}"
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <select class="form-control" name="id_pengguna" id="id_pengguna" required>
                                                ...
                                                @foreach ($pengguna as $k)
                                                    <option {{ $k->id_pengguna == $pembeli->id_pengguna ? 'selected' : '' }}
                                                        value="{{ $k->id_pengguna }}">
                                                        {{ $k->username }}
                                                    </option>
                                                @endforeach
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input id="middle-name" name="nama" value="{{ $pembeli->nama }}" class="form-control" type="text"
                                                name="middle-name">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input id="middle-name" name="usia" value="{{ $pembeli->usia }}" class="form-control" type="text"
                                                name="middle-name">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Jenis
                                            Kelamin</label>
                                        <div class="col-md-6 col-sm-6 ">
                                            <input id="middle-name" name="jenis_kelamin" value="{{ $pembeli->jenis_kelamin }}" class="form-control" type="text"
                                                name="middle-name">
                                        </div>
                                    </div>
