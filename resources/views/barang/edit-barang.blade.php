                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            <div class="x_content">
                                <br />
                                <form id="demo-form2" action="{{ route('barang.update', $barang->id_barang) }}"
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <select class="form-control" name="id_pembeli" id="id_pembeli" required>
                                                @foreach ($pembeli as $hot)
                                                    <option {{ $hot->id_pembeli == $barang->id_pembeli ? 'selected' : '' }}
                                                        value="{{ $hot->id_pembeli }}">
                                                        {{ $hot->nama }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <select class="form-control" name="id_pegawai" id="id_pegawai" required>
                                                @foreach ($pegawai as $hot)
                                                    <option {{ $hot->id_pegawai == $barang->id_pegawai ? 'selected' : '' }}
                                                        value="{{ $hot->id_pegawai }}">
                                                        {{ $hot->nama }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <select class="form-control" name="id_gudang" id="id_gudang" required>
                                                @foreach ($gudang as $hot)
                                                    <option {{ $hot->id_gudang == $barang->id_gudang ? 'selected' : '' }}
                                                        value="{{ $hot->id_gudang }}">
                                                        {{ $hot->id_gudang }}
                                                    </option>
                                                @endforeach
                                    ...
                                    <div class="item form-group">
                                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Nama
                                            Barang</label>
                                        <div class="col-md-6 col-sm-6 ">
                                            <input id="middle-name" name="nama_barang" value="{{ $barang->nama_barang }}" class="form-control" type="text"
                                                name="middle-name">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Stok
                                            Barang</label>
                                        <div class="col-md-6 col-sm-6 ">
                                            <input id="middle-name" name="stok_barang" value="{{ $barang->stok_barang }}" class="form-control" type="text"
                                                name="middle-name">
                                        </div>
                                    </div>
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <input id="middle-name" name="kategori_barang" value="{{ $barang->kategori_barang }}"  class="form-control"
