...
<html lang="en">
  <head>
    ...
    <title>PT Gajah Tunggal | Product Category</title>
        ...
        <div class="main-title">
          <div class="home-content">
            ...
            <tr>
                ...
                <td>Pr001</td>
                <td>GT Radial</td>
                <td>Standard car Tire</td>
            </tr>
            <tr>
                <td>Pc002</td>
                <td>Pr002</td>
                <td>GITI</td>
                <td>Tronton TruckTire</td>
            </tr>
            <tr>
                <td>Pc003</td>
                <td>Pr003</td>
                <td>GT Gajah Tunggal</td>
                <td>Trailer Truck Tire</td>
            </tr>
            <tr>
                <td>Pc004</td>
                <td>Pr004</td>
                <td>IRC Tire</td>
                <td>Standard Motorcycle Tire</td>
            </tr>
            <tr>
                <td>Pc005</td>
                <td>Pr005</td>
                <td>Zeneos</td>
                <td>Large Motorcycle Tire</td>
            </tr>
    </table>
            </table>
               </tbody>
