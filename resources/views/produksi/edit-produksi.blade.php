                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 ">
                        <div class="x_panel">
                            <div class="x_content">
                                <br />
                                <form id="demo-form2" action="{{ route('produksi.update', $produksi->id_produksi) }}"
                                        ...
                                        <div class="col-md-6 col-sm-6 ">
                                            <select class="form-control" name="id_tenagakerja" id="id_tenagakerja" required>
                                                ...
                                                @foreach ($tenaga_kerja as $k)
                                                    <option
                                                        {{ $k->id_tenagakerja == $produksi->id_tenagakerja ? 'selected' : '' }}
                                    ...
                                    <div class="item form-group">
                                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Biaya
                                            Produksi</label>
                                        <div class="col-md-6 col-sm-6 ">
                                            <input id="middle-name" name="biaya_produksi" value="{{ $produksi->biaya_produksi }}" class="form-control"
                                    ...
                                    <div class="item form-group">
                                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Stok
                                            Produksi</label>
                                        <div class="col-md-6 col-sm-6 ">
                                            <input id="middle-name" name="stok_produksi" value="{{ $produksi->stok_produksi }}" class="form-control" type="number"
                                                name="middle-name">
                                        </div>
                                    </div>
